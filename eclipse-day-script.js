...
sky6Utils.ConvertCalenderToJulianDate(2024,4,8,12,11,20) // Input time to start slew to eclipse field in (YYYY, MM, DD, HH, MM, SS) *local* system time
t2 = sky6Utils.dOut0 // Save time for slew to eclipse field t2 as Julian date
sky6Utils.ConvertCalenderToJulianDate(2024,4,8,12,13,55) // Input time to start slew to left field in (YYYY, MM, DD, HH, MM, SS) *local* system time
t3 = sky6Utils.dOut0 // Save time for slew to left calibration field t3 as Julian date
sky6Utils.ConvertCalenderToJulianDate(2024,4,8,12,14,59) // Input time for end of eclipse in (YYYY, MM, DD, HH, MM, SS) *local* system time
